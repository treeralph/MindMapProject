...
import com.gyso.treeview.sample.Element;
...
public class TreeViewContainer extends ViewGroup implements TreeViewNotifier {
    ...
    private ReleasedCallback releasedCallback;
    ...
    */
    ...
    public void setReleasedCallback(ReleasedCallback callback) {
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback(){
        ...
        public void onViewReleased(@NonNull  View releasedChild, float xvel, float yvel) {
            ...
            if(getHit){
                 ...
                 * @Author: jun
                 * @action: update
                 * todo: hittingNode == pseudoNode ? operate (add targetNode to root, not hittingNode) : continue.
                 * */
                Log.e(TAG, "onViewReleased: " + "Here????????");
                ...
                if(releasedCallback != null){
                    ...
                    relation.put("released", releasedChildHolderNode);
                    relation.put("targeted", targetHolderNode);
                    releasedCallback.onCallback(relation);
                }
    ...
    /**
     * @Author jun
     * @param string include Element id.
     * @Role extract Element id from target.
     * */
    public static int extractId(String string) throws Exception{
        String regex1 = "id=([^,]*),";
        ...
        if(matcher.find()){
            ...
            throw new Exception("There doesn't exist a Match");
        }
    }
